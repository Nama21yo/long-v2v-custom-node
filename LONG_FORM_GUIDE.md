...
* *Context Overlap:* 8 frames.


* **Why Overlap?** The last 8 frames of *Batch 1* become the "context" for the start of *Batch 2*. This ensures the AI knows what the character was doing, preventing sudden jumps.
...
* **The "Seam" Fix:** It takes the *Overlap* area (where Batch 1 ends and Batch 2 starts) and blends them using a **Linear Cross-Fade**. This makes the transition invisible to the human eye.
