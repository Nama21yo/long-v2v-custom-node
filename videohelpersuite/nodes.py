...
from .load_video_nodes import LoadVideoUpload, LoadVideoPath, LoadVideoFFmpegUpload, LoadVideoFFmpegPath, LoadImagePath, LoadVideoSingleton
...
from .frame_processor_node import FrameByFrameVideoProcessor
from .video_merger_node import VideoMerger
...
NODE_CLASS_MAPPINGS = {
    ...
    "VHS_LoadVideoSingleton" : LoadVideoSingleton,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "VHS_LoadVideoSingleton" : "Load Video Singleton(Path)",
